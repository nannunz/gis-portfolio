...
I ultimately decided to develop a housing vulnerability prediction model for the Legal Aid Society, an organization in New York City that offers pro bono legal services to low-income New Yorkers across all five boroughs. This model was developed in ArcGIS Pro because the Legal Aid Society is [relatively well resourced](https://www.causeiq.com/organizations/the-legal-aid-society,135562265/). New York’s residents are deeply stratified on the basis of race and class, and evictions for the city’s most vulnerable are not uncommon. Unfortunately, evictions and a lack of access to stable housing can result in a ripple effect through other aspects of a person’s life, resulting in job loss, food insecurity, or poor educational outcomes. 
